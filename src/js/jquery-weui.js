...
+ function($) {
  ...
  $.modal = function(params, onOpen) {
    ...
    var buttonsHtml = buttons.map(function(d, i) {
      return '<a href="#" class="weui_btn_dialog ' + (d.className || "") + '">' + d.text + '</a>';
    }).join("");
...
+ function($) {
  ...
  var Picker = function (params) {
      ...
      var defaults = {
          ...
          <a href="#" class="picker-button close-picker">{{closeText}}</a>\
...
+ function($) {
  ...
  defaults = $.fn.select.prototype.defaults = {
    ...
    toolbarTemplate: '<div class="toolbar">\
      <div class="toolbar-inner">\
      <a href="#" class="picker-button close-select">{{closeText}}</a>\
      <h1 class="title">{{title}}</h1>\
      </div>\
      </div>',
    radioTemplate:
